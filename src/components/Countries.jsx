      ...
      {loading ? 'Loading... ': " "}
        {countriesList
          ...
          .map((country, i) => (<Col key={i} className="mt-5">
              ...
              <i className='bi bi-heart-fill text-danger m-1 p-1 favIcon' onClick={() => dispatch(removeFavourites(country.name.common))} >
              </i>

              ) : (

              <i className="bi bi-heart text-danger m-1 p-1 favIcon" 
                ...
                <Card.Img variant="top" src={country?.flags?.svg} alt={country.flags.alt} />
                  <Card.Body className="d-flex flex-column">
                    ...
                    >
                      ...
                      <ListGroup.Item >
                        <i className="bi bi-cash-coin me-2" >     { Object.values(country.currencies || {}).map((currency)=> currency.name).join(', ')}
                        </i>
                      </ListGroup.Item>
                      <ListGroup.Item>
